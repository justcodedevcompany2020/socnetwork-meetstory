    ...
    <Tab.Navigator
      ...
      screenOptions={({ route }) => ({
        ...
        tabBarStyle: (() => {
          ...
          if (routeName === 'CommentsScreen' || routeName === 'ForumSingle' || routeName === 'ChangeTemaScreen' || routeName === 'accountAndSecurityScreen' || routeName === 'PrivacyScreen' || routeName === 'ChatScreen' || routeName === 'SettingScreen' || routeName === 'AboutAs' || routeName === 'ChangePasswordScreen' || routeName === 'NotificationScreen') {
            return {
              display: 'none',
              height: 0
            };
