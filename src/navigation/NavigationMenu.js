    ...
    <Tab.Navigator
      ...
      screenOptions={({ route }) => ({
        ...
        tabBarStyle: (() => {
          ...
          if (routeName === 'CommentsScreen' || routeName === 'ForumSingle' ||routeName === 'SettingScreen'||routeName === 'AboutAs'|| routeName === 'PrivacyScreen' || routeName === 'ChnagePasswordScreen' ||routeName === 'NotificationScreen') {
            return {
              display: 'none',
              height: 0
            };
